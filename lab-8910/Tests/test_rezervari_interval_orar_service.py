...
def test_rezervari_interval_orar():
    filename = "Tests/test_rezervari_interval_orar.json"
    clear_file(filename)
    ...
    assert \
        rezervare_service.rezervari_interval_orar(
            10.00, 13.00) == [Rezervare(id_entitate='1',
                                        id_film='1',
                                        id_card_client=None,
